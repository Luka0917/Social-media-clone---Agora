...
export default function TabletAuth({ isSignIn, toggleAuth }: MobileAuthProps){
    const { theme, themeToggle } = useStore();

    return (
        <div className={`${theme === 'light' ? 'bg-[#f5f8fb]' : 'bg-[#080d14]'} flex flex-col justify-center items-center min-h-screen w-full`}>
