...
export default function TabletNavbar(){
    ...
    return (
        <div className={`${theme === 'light' ? 'bg-[#f5f8fb] text-[#0e141f] border-[#dae0e8]' : 'bg-[#080d14] text-[#eef2f7] border-[#222a35]'} flex justify-between items-center py-2 px-5 border-b relative z-10`}>
            <div className="flex justify-center items-center gap-5">
                ...
                <div className={`${theme === 'light' ? 'bg-[#eef3f9] border-[#dae0e8] ring-[#9ac2f6]' : 'bg-[#141a25] border-[#222a35] ring-[#224477]'} border rounded-full py-1.5 px-2 flex justify-start items-center w-80 focus-within:ring-2 transition-all duration-200`}>
            ...
            <div className="flex justify-center items-center gap-3">
                ...
                <Link to={'/'} className={`${theme === 'light' ? 'border-[#dae0e8] bg-[#f0f4fa] hover:bg-[#deeaf9]' : 'border-[#2b3038] bg-[#131822] hover:bg-[#0e192b]'} flex justify-center items-center gap-2 border rounded-full p-0.5 pr-3 transition-all duration-200`}>
                    <img src="../../public/pfp.svg" alt="pfp" className={`${theme === 'light' ? 'border-[#9bc1f5]' : 'border-[#29497c]'} border-2 rounded-full w-10 h-10`} />
                    <span className={`${theme === 'light' ? 'text-[#0e141f]' : 'text-[#eef2f7]'} text-sm font-medium`}>@username</span>
                </Link>
            </div>
        </div>
    )
